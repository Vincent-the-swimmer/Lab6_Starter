...
class RecipeCard extends HTMLElement {
	...
	set data(data) {
		...
		// imgArticle.src = data.imgSrc;
		// imgArticle.alt = data.imgAlt;
		// articleSelect.append(imgArticle);
		
		// const pTitle = document.createElement("p");
		// const linkTitle = document.createElement("a");
		// linkTitle.textContent = data.titleTxt;
		// linkTitle.href = data.titleLnk;
		// pTitle.append(linkTitle);
		// articleSelect.append(pTitle);

		// const pOrg = document.createElement("p");
		// pOrg.textContent = data.organization;
		// articleSelect.append(pOrg);

		// const divOrg = document.createElement("div");
		// const spanRatingOrg = document.createElement("span");
		// const imgOrg = document.createElement("img");
		// const spanNumRatingOrg = document.createElement("span");
		// spanRatingOrg.textContent = data.rating;
		// imgOrg.src = "/assets/images/icons/5-star.svg";
		// imgOrg.alt = "5 stars";
		// spanNumRatingOrg.textContent = data.numRatings;
		// divOrg.append(spanRatingOrg);
		// divOrg.append(imgOrg);
		// divOrg.append(spanNumRatingOrg);
		// articleSelect.append(divOrg);

		// const timeElement = document.createElement("time");
		// timeElement.textContent = data.lengthTime;
		// articleSelect.append(timeElement);
